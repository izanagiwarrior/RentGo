                    ...
                    <div class="car-details">
                        ...
                        <div class="col-md-6">
                            <div class="text text-center">
                                <span class="subheading">{{ 'Rp ' . number_format($product->price, 2, ',', '.') }}
                                    <span>/day</span></span>
                                <h2>{{ $product->title }}</h2>
                            </div>
                            <form action="{{ route('user.order', $product->id) }}" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control form-control-user" name="start"
                                        placeholder="{{ __('Start') }}" value="{{ old('start') }}" required autofocus>
                                </div>
                                <div class="form-group">
                                    <label class="form-control-label" for="duration">{{ __('Duration (Day)') }}<span
                                            class="small text-danger">*</span></label>
                                    <input type="number" class="form-control form-control-user" name="duration"
                                        placeholder="{{ __('Duration') }}" value="{{ old('duration') }}" required>
                                </div>
                                <!-- Button -->
                                <div class="pl-lg-4">
                                    <div class="row">
                                        <div class="col text-center">
                                            <a href="{{ url()->previous() }}" class="btn btn-dark py-2 mr-1">Back</a>
                                            <button type="submit"
                                                class="btn btn-primary py-2 mr-1">{{ __('Book Now') }}</button>
                                        </div>
                                    </div>
                                </div>
                            </form>
